					...
					<div class='col-md-6'>
						...
						<div class="panel panel-default">
						  ...
						  <div class="panel-body">
						    <button class="btn btn-success" type="button" onclick="location.href='/SentimentAnalysis/analysis.jsp'" >
						...
						<div class="panel panel-default">
						  ...
						  <div class="panel-body">
						    <button class="btn btn-danger" type="button" onclick="location.href='/SentimentAnalysis/analysis.jsp'">
